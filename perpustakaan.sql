...
(3, '2021_06_08_072508_create_bukus_table', 1),
(4, '2021_06_08_073045_create_pegawais_table', 1);
...
CREATE TABLE `pegawais` (
  `id` int(10) UNSIGNED NOT NULL,
  `id_pegawai` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT '1',
  `nama` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT '1',
  `jenis_kelamin` enum('Pria','Wanita') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `no_hp` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT '1',
  `alamat` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT '1',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1, 'PG100', 'Jesyca', 'Wanita', '081222222222', 'Medan', '2021-06-08 09:56:58', NULL);
